...
见 `docs/superpowers/plans/2026-07-11-pi-phase2-db-compat.md`（Phase 2 计划文档）。
目标：给 v2/engine 一个能与生产 `agent_data.db` 直接共存的存储层——绞杀者阶段
...
`.env`（dotenv 从进程 cwd 读；`npm start` 的 cwd 是 `v2/engine`）：
